  ...
  namespace :snapshots do
    ...
    module RestoreAnalytics
      ...
      CUSTOM_EXPORT_SELECTS = {
        ...
        users: "(SELECT id,role,created_at,updated_at,classcode,active,token,clever_id,signed_up_with_google,send_newsletter,google_id,last_sign_in,last_active,stripe_customer_id,flags,time_zone,title,account_type,post_google_classroom_assignments FROM users)",
